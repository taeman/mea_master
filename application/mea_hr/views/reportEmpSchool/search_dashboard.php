...
<div class="form-group <?php echo $classTitle ?>">สืบค้นข้อมูลคุณวุฒิการศึกษาของพนักงาน</div>
    <table width="100%">
        ...
        <tr>
            ...
            <td><input type='text' name='school' id='school' class='form-control' value="<?php echo $_GET['school']; ?>"></td>
...
<script>
    function submit_form(){
        ...
        parent.location.href="index.php?controller=reportEmpSchool&fn=detail&id="+id+"&name="+name+"&position="+position+"&department="+department+"&divition="+divition+"&party="+party+"&school="+school+"&education="+education;
    }
    function reset_form(){
        var id = $('#id').val('');
        var name = $('#name').val('');
