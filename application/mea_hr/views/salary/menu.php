<?php
/**
* @comment เมนู สำหรับส่วน salary
* @projectCode 57LIQ01
* @tor 3.2.4.2.2.1
* @package core
...
<div class="block" id="menu" style="width:99%; margin-right:0.5%; text-align:right;">
	<?php if($_GET['fn']=="dashboard"){?>
		<img src="../../images/mea_hr/icon-create.png" class="btn-img" onclick="document.location='?controller=salary&fn=add'" title="เพิ่มข้อมูล" />
	...
	<?php }else{?>
		...
		<?php } ?>
		<img src="../../images/mea_hr/icon-cancel.png" class="btn-img" onclick="document.location='?controller=salary&fn=dashboard'" title="ยกเลิก" />
	<?php } ?>
