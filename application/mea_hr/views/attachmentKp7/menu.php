<?php
/**
* @comment menu สำหรับหน้าจอการแนบเอกสาร ก.พ.7 ต้นฉบับ
* @projectCode 		57LIQ01
* @tor 				3.2.4.2.2.1
* @package 			core
...
<?php if($function == '' || $function == 'dashboard'){ ?>
	<img src="../../images/mea_hr/icon-create.png" class="btn-img" onclick="document.location='?controller=attachmentKp7&fn=form_keyin'" title="เพิ่มข้อมูล" />
...
<?php }elseif($function == 'form_keyin'){ ?>
    ...
    <?php } ?>
    <img src="../../images/mea_hr/icon-cancel.png" class="btn-img" onclick="document.location='?controller=attachmentKp7&fn=dashboard'" title="ยกเลิก" />
<?php } ?>
</div>