...
$arrData[0][infraction_date_group] = '30 วัน';
...
$arrData[1][infraction_date_group] = '60 วัน';
...
$arrData[2][infraction_date_group] = '60 วัน';
...
$arrData[3][infraction_date_group] = '90 วัน';
...
$arrData[4][infraction_date_group] = '120 วัน';
...
$titleHighChart = '';
$text = 'ระยะเวลาที่ไม่ส่งรายละเอียดให้ ฝบก.';
$valueSuffix = 'คน';
$data_charts = "{
                        color: '#00CC33',
                        name: 'จำนวน (รายการ)',
...
# เรียกใช้ views reportEmpEducate
	...
	$data['frequency'] = '1';
include("views/reportOverAnnounce/dashboard.php");
?>
<script>
$(function () {
