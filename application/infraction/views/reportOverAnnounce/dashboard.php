...
<div class="form-group <?php echo $classTitle ?>">รายงานสรุปการกระทำละเมิดที่การไฟฟ้าเขตไม่ส่งรายละเอียดให้ฝบก. เกินระยะเวลา 30, 60, 90 และ 120 วัน</div>
...
<tr>
	<td style="width:50%">
    	<table class="<?php echo $classTable?>">
        	<thead>
                <tr bgcolor="#eaeaea">
                    <th>ระยะเวลาที่ไม่ส่งรายละเอียดให้ ฝบก.</th>
                    <th>จำนวน (รายการ)</th>
                </tr>
			</thead>
            <tbody>
            <?php
             ...
             foreach($summaryList as $id => $detail){ ?>
                <tr class>
                    <td style="width:20%" class="text-center"><?php echo $detail->educate; ?></td>
                    <td style="width:10%" class="text-right"><?php echo $detail->numberEmp; ?></td>
                </tr>
            <?php $i++;$sum+=intval($detail->numberEmp); } ?>
            </tbody>
						<tfoot>
							<tr bgcolor="#eaeaea">
								<th class="text-center"> รวม </th>
								<th class="text-right"><?php echo $sum; ?></th>
							</tr>
						</tfoot>
        </table>
    </td>
    	...
    	<table class="<?php echo $classTable?>">
            ...
            <?php
						 ...
						 <tr class="tr-link" onclick="$('a.fancy-request').trigger('click');">
							 ...
							 <td class="text-center"><?php echo $detail->infraction_date_group; ?></td>
						 </tr>
						<?php $i++; } ?>
            </tbody>
        </table>
