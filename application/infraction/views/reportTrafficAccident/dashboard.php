...
<div class="form-group <?php echo $classTitle ?>">รายงานจราจร อุบัติเหตุรายเดือน<?php echo $month_th[date('n')]; ?></div>
...
<tr>
	<td style="width:50%">
    	<table class="<?php echo $classTable?>">
        	<thead>
                <tr bgcolor="#eaeaea">
                    <th colspan="2">อุบัติเหตุการจราจรที่เกิดขึ้นมากที่สุด 5 อันดับ</th>
                </tr>
                <tr bgcolor="#eaeaea">
                    <th>อุบัติเหตุ</th>
                    <th>จำนวน (รายการ)</th>
