...
* @created 			21/01/2016
*/
$pdf = rawurlencode("http://".$_SERVER['HTTP_HOST']."/mea_hr_mvc/application/mea_hr/popup.php?controller=reportEducate&fn=dashboard&printPdf=true");
...
<div class="block" id="menu" style="width:99%; margin-right:0.5%; text-align:right;">
    ...
    <a href="popup.php?controller=reportEducate&fn=search_dashboard&DStart=<?php echo $_GET['DStart']; ?>&DEnd=<?php echo $_GET['DEnd']; ?>&position=<?php echo $_GET['position']; ?>&department=<?php echo $_GET['department']; ?>&divition=<?php echo $_GET['divition']; ?>&party=<?php echo $_GET['party']; ?>&education=<?php echo $_GET['education']; ?>" id="filter"><img src="../../images/mea_hr/icon-search.png" class="btn-img" title="พิมพ์รายงาน" /></a>
