<?php
/**
* @comment ไฟล์ถูกสร้างขึ้นมาสำหรับเป็น Controls ให้ระบบ เชื่อมโยงโปรแกรมประยุกต์กับระบบงานที่เกี่ยวข้อง
* @projectCode PS58MKT
* @tor 1.2.1
* @package core
...
$controller = ($_GET['controller'] == '') ? 'exchange_data' : $_GET['controller'];
