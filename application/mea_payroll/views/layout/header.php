...
<div class="navbar-menu block" style="width:100%">
	...
	<div class="block" style="padding:10px;">
		<img src="../../images/mea_payroll/icon-payroll.png" alt="Applications" class="btn-img" onclick="document.location='index.php'" title="Applications" width="40">
    </div>
<?php if($_GET['controller']!='main_payroll'&&$_GET['controller']!='payroll'&&$_GET['controller']!='general'&&$_GET['controller']!=""){ ?>
    <div class="block">
    <nav class="navbar">
