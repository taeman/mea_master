...
$controller = ($_GET['controller'] == '') ? 'main_payroll' : $_GET['controller'];
$function = ($_GET['fn'] == '') ? 'main_payroll' : $_GET['fn'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>ระบบบัญชีเงินเดือนและสวัสดิการ</title>
</head>
...
<div class="block" style="width:100%; height:auto;">
    ...
    <div class="block" id="body" style="width:99%; height:auto !important; min-height:500px; margin:0.5%; background:#FFF ">
		<?php echo $controller=="main_payroll"?"<p style='margin-top:100px'>":""?>
		<?php include("controls/".$controller."/".$function.".php"); ?>
		<?php echo $controller=="main_payroll"?"</p>":""?>
    </div>
    <div class="block text-center" id="footer" style="width:100%; height:45px; background:#ededed;">
		<p style="margin-top:10px;"><font style="font-family:Helvetica Neue,Helvetica,Arial,sans-serif; font-size:14px;">Copyright (c) 2016 Liquor Distillery Organization Excise Department. Powered by Sapphire.</font></p>
    </div>
</div>
</body>
</html>