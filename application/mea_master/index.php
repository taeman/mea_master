...
$controller = ($_GET['controller'] == '') ? 'main_master' : $_GET['controller'];
$function = ($_GET['fn'] == '') ? 'menu_master' : $_GET['fn'];
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>ระบบจัดเก็บสถิติการละเมิดทรัพย์สินในระบบจำหน่าย กฟน.</title>
</head>
...
<div class="block" style="width:100%; height:auto;">
    ...
    <div class="block" id="body" style="width:99%; height:auto !important; min-height:500px; margin:0.5%; background:#FFF">
		<?php echo $function=="menu_master"?"<p style='margin-top:100px'>":""?>
        <?php include("controls/".$controller."/".$function.".php"); ?>
		<?php echo $function=="menu_master"?"</p>":""?>
    </div>
