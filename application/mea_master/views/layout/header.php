...
<div class="navbar-menu block" style="width:100%">
	<div class="block" style="padding:10px;">
		<img src="../../images/mea_hr/icon-mea.png" alt="Applications" class="btn-img" onclick="document.location='index.php'" title="Applications" width="40">
    </div>
<?php if($_GET['controller']!='main_master'&&$_GET['controller']!='general'&&$_GET['controller']!=""){ ?>
    <div class="block">
    <nav class="navbar">
...
<div id="navbar" class="collapse navbar-collapse">
    ...
    <li>
        <a href="../mea_setting/index.php?controller=setting_preference&fn=setting_preference" class="navbar-img" title="Preference">
            <div>
